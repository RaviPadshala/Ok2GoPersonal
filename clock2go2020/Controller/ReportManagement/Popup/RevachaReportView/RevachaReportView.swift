...
class RevachaReportView: UIView {
    ...
    @IBOutlet weak var clientTitle: UILabel!
    ...
    private func commonInit() {
        Bundle.main.loadNibNamed("RevachaReportView", owner: self, options: nil)
    ...
    func setupTaps() {
        ...
        let tapClient = UITapGestureRecognizer(target: self, action: #selector(chooseCLient))
        clientView.isUserInteractionEnabled = true
        clientView.addGestureRecognizer(tapClient)
