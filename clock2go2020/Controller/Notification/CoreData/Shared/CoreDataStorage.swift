...
open class CoreDataStorage {
    ...
    @objc func contextDidSavePrivateQueueContext(_ notification: Foundation.Notification) {
        if let context = self.mainQueueCtxt {
            self.synced(self, closure: { () -> Void in
    ...
    @objc func contextDidSaveMainQueueContext(_ notification: Foundation.Notification) {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "NotificationSavedModel", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let directory = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.cacheNotifications")!
        let url = directory.appendingPathComponent("NotificationSavedModel.sqlite")
        do {
...
extension NSManagedObject {
    ...
    public class func findAllForEntity(entityName: String, context: NSManagedObjectContext) -> [AnyObject]? {
        ...
        do {
            result = try context.fetch(request) as [AnyObject]
