...
class AddCompTaskEndpoint: EndpointItem {
    var taskCode: Int?
    var taskName: String?
    var projectId: Int?
    var hourPrice: Int?
    ...
    init(taskCode: Int, taskName: String, projectId: Int, hourPrice: Int, budgetHours: Int ) {
        ...
        super.init(endpointType: .addCompTask)
    }
